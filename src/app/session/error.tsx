  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
      <div className="text-center space-y-5 p-8 max-w-sm">
        ...
        <h1 className="text-xl font-semibold font-[family-name:var(--font-exo2)]">Session unavailable</h1>
        <p className="text-sm text-muted-foreground">We couldn&apos;t load this session. It may have ended or there was a connection issue.</p>
